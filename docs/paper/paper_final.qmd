...
This framework extends CDISC ADaM principles to accommodate ER modeling requirements. We propose four example specialized dataset types aligned with major ER domains:
