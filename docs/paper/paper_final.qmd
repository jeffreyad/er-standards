...
The CDISC BDS standards for PopPK provide valuable principles applicable to ER analyses:
...
| ADTRR    | BDS (longitudinal)                       | 1 record per subject per visit/time pt | Tumor response ER
