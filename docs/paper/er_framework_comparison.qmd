...
var_key <- tibble(
  Variable = c("C", "PTNM", "TRT", "DOSE", "TIME", "NTIM", "OS", "OSOS", 
...
adee <- tibble(
  ...
  PARAM = c("Overall Survival", "Progression-Free Survival", "Time to Progression",
...
ades <- tibble(
  ...
  PARAM = c("Treatment-Emergent AEs", "Treatment-Emergent Severe AEs",
...
adtrr <- tibble(
  ...
  PARAM = c("Target Lesion Size", "Target Lesion Size", "Target Lesion Size",
